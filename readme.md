...
1. Kopier ```move-mocks/ip/mock.jks```, ```move-mocks/ip/mock-truststore.jks```, ```integrasjonspunkt-local.properties``` og ```move-mocks/ip/kontaktinfo-client.pem``` working directory for integrasjonspunktet.
